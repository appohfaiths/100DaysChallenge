...
I created this repo to share tips, resources and doses of motivation to help you start and finish the 100 Days Learning Challenge, whether you want to learn software engineering, UI/UX design, data science, data engineering, open source, etc. Learning resources can be found [here](https://github.com/ivybarley/100DaysChallenge/blob/main/RESOURCES.md).
