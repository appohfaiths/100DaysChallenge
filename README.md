...
| 55 | GitHub Learning Labs| Get familiar with how GitHub works via GitHub Learning Labs (https://lab.github.com/) with free courses and learning paths on GitHub, DevOps, programming languages and tools. You can also work on hands-on lessons on and get access to a helpful bot.|
